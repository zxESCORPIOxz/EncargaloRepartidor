...
import mx.com.encargalo.repartidor.Entidades.sp_Entidadtermsconsuso;
    ...
    private void mostrarTermsConsDetalle() {
        ...
        switch (tipoDetalle){
            case "terminos_condiciones":{
                url= DATOS.IP_SERVER+"c_consultar_terms_condiciones_uso.php";
                jsonArrayName = "termscondicionesuso";
                break;
            }
            case "politica_privacidad":{
                url= DATOS.IP_SERVER+"c_consultar_politicas_privacidad.php";
                jsonArrayName = "politicasprivacidad";
                break;
            }
            case "productos_prohibidos":{
                url= DATOS.IP_SERVER+"c_consultar_produc_prohibido.php";
